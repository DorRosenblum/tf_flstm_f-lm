from tensorflow.python.ops.rnn_cell_impl import _like_rnncell as RNNCell#from tensorflow.python.ops.rnn_cell_impl import _RNNCell as RNNCell
from tensorflow.contrib.rnn.python.ops.core_rnn_cell import *#from tensorflow.contrib.rnn.python.ops.core_rnn_cell_impl import LSTMStateTuple
from tensorflow.contrib.rnn.python.ops.core_rnn_cell import _linear as linear#from tensorflow.contrib.rnn.python.ops.core_rnn_cell_impl import _linear as linear
